...
public class App {
    ...
    public static Animal crearAnimal(ProtectoraDeAnimales pAnimales){
        String id = String.valueOf(pAnimales.getAnimals().size()+1);
    ...
    public static void main(String[] args) {
        ...
        Path ruta = Path.of("/home/juarodgra2/Documents/Tema2.Practica2/src/main/resources/animales.xml");
       ProtectoraDeAnimales pAnimales= XmlService.leerArrayObjetosXml(ruta);
        ...
        while (condition){
            ...
            switch (in.nextInt()) {
                ...
                case 2:
                    in.nextLine();
                    pAnimales.deleteAnimal(in.nextLine());
                    break;
                case 3:
                    in.nextLine();
                    pAnimales.findAnimal(in.nextLine());
                    break;
                case 4:
        ...
        XmlService.escribirListaObjetosXml(ruta,pAnimales);
    }
